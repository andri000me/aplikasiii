...
<head>
  ...
  <link href="<?php echo base_url()?>assets/logo_bpkp2.png" rel="shortcut icon">
  <!-- Bootstrap 3.3.7 -->
  ...
  <div class="login-box-body">
    ...
    <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo base_url()?>assets/logo_bpkp2.png" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          <p>Pusdiklatwas BPKP</p>
        </div>
      </div>
<?php echo $this->session->flashdata('message');?>
    ...
    <a href="<?php echo site_url('Login/register_member'); ?>" class="text-center">Register a new membership</a>
